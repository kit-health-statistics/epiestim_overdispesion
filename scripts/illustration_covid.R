...
R_hat <- list(
  pois = exp(mod_pois$coefficients),
  nbin2 = exp(mod_nbin2$mu.coefficients),
  nbin1 = exp(mod_nbin1$mu.coefficients)
)
...
ggsave("figure/rel_llik_curvature.pdf", p_curvature, width = 7, height = 3.5)
